...
TEST_GROUP_RUNNER(SysTickDispatcher)
{
    ...
    RUN_TEST_CASE(SysTickDispatcher, Subscribe_WhenNoInit_ReturnsFail);
    RUN_TEST_CASE(SysTickDispatcher, Subscribe_WhenTaskIsNull_ReturnsFail);
    RUN_TEST_CASE(SysTickDispatcher, Subscribe_CorrectArguments_ReturnsSuccess);
    RUN_TEST_CASE(SysTickDispatcher, Subscribe_CanSubscribeMaxTasks);
    RUN_TEST_CASE(SysTickDispatcher, Subscribe_WhenOverMaxTasks_ThrowsError);
    RUN_TEST_CASE(SysTickDispatcher, Subscribe_WhenRegisteringSameTask_ThrowsError);
    ...
    RUN_TEST_CASE(SysTickDispatcher, Unsubscribe_WhenTaskIsNull_ReturnFail);
    RUN_TEST_CASE(SysTickDispatcher, Unsubscribe_WhenPeriodIsZeroAndTaskIsNull_ReturnFail);
    RUN_TEST_CASE(SysTickDispatcher, CanUnsubscribeMAX);
    ...
    RUN_TEST_CASE(SysTickDispatcher, Wakeup_AllTasksCanBeCalled);
